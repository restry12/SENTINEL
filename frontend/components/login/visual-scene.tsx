...
import { Flame, ShieldAlert, Activity, Globe } from 'lucide-react';
  ...
  return (
    <section className={styles.scene}>
      ...
      <div className={styles.globeWrap} aria-hidden="true">
          ...
          <svg viewBox="0 0 200 200" preserveAspectRatio="xMidYMid meet">
            <defs>
              ...
              <linearGradient id="link" x1="0" y1="0" x2="1" y2="0">
                ...
                <stop offset="60%" stopColor="rgba(56,189,248,.8)"/>
        ...
        {/* fire foci - Refined vibrant glow */}
        ...
        {/* corner labels - Refined design pass */}
